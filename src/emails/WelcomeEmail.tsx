...
const WelcomeEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to OnlyFan!</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              // src={`${BASE_URL}/horse-1.png`} //👈uncomment this url for production
              src={`https://i.ibb.co/CV1mKKY/horse-1.jpg`} //👈uncomment this one for development only
              width="600"
              height="400"
              alt="welcome icon"
              style={{ margin: "auto", borderRadius: 10 }}
            />
            <Heading style={{ ...global.heading }}>Welcome to OnlyFan!</Heading>
          ...
          <Section style={global.defaultPadding}>
            <Text style={footer.text}>
              © {new Date().getFullYear()} OnlyFan, Inc. All Rights Reserved.
            </Text>
          </Section>
        </Container>
      </Body>
